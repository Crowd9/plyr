typeof navigator === "object" && (function () {
	...
	*/
	...
	function () {
	  ...
	  _createClass(Ads, [{
	        ...
	        this.cuePoints.forEach(function (cuePoint) {
	          if (cuePoint !== 0 && cuePoint !== -1 && cuePoint < _this7.player.duration) {
	            ...
	            if (is$2.element(seekElement)) {
	              ...
	              cue.style.setProperty('left', "".concat(cuePercentage.toString(), "%"), 'important');
	    ...
	    value: function pauseContent() {
	      ...
	      this.elements.container.style.setProperty('z-index', 3, 'important'); // Ad is playing
	  ...
	  _createClass(PreviewThumbnails, [{
	    ...
	    value: function setThumbContainerSizeAndPos() {
	      if (!this.sizeSpecifiedInCSS) {
	        ...
	        this.elements.thumb.imageContainer.style.setProperty('height', "".concat(this.thumbContainerHeight, "px"), 'important');
	        this.elements.thumb.imageContainer.style.setProperty('width', "".concat(thumbWidth, "px"), 'important');
	      }
	    ...
	    value: function setThumbContainerPos() {
	      ...
	      container.style.setProperty('left', "".concat(previewPos, "px"), 'important');
	    } // Can't use 100% width, in case the video is a different aspect ratio to the video container

	  }, {
	    key: "setScrubbingContainerSize",
	    value: function setScrubbingContainerSize() {
	      this.elements.scrubbing.container.style.setProperty('width', "".concat(this.player.media.clientWidth, "px"), 'important'); // Can't use media.clientHeight - html5 video goes big and does black bars above and below

	      this.elements.scrubbing.container.style.setProperty('height', "".concat(this.player.media.clientWidth / this.thumbAspectRatio, "px"), 'important');
	    ...
	    value: function setImageSizeAndOffset(previewImage, frame) {
	      ...
	      previewImage.style.setProperty('height', "".concat(Math.floor(previewImage.naturalHeight * multiplier), "px"), 'important'); // eslint-disable-next-line no-param-reassign

	      previewImage.style.setProperty('width', "".concat(Math.floor(previewImage.naturalWidth * multiplier), "px"), 'important'); // eslint-disable-next-line no-param-reassign

	      previewImage.style.setProperty('left', "-".concat(frame.x * multiplier, "px"), 'important'); // eslint-disable-next-line no-param-reassign

	      previewImage.style.setProperty('top', "-".concat(frame.y * multiplier, "px"), 'important');
	    }
	  }, {
	    key: "enabled",
	    get: function get() {
	...
	var myMock = function myMock(obj) {
	  var keys = is$2.array(obj) ? Object.keys(obj) : Object.getOwnPropertyNames(obj);
	  var dumb = is$2.array(obj) ? [] : {};
